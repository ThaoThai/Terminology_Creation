...
<div class="wrapper1">
	<div id="about" class="container">
        ...
        <h4>There is a lack of translation for technical terminologies in the World Wide Web. Not all the technical terms in English are being translated to different languages. Some languages do not even have the translation for these technical terms. Therefore, the goal of Terminology Creation is to provide a web interface translator for uncommon technical terminologies. Users will also be able to input their own translation of technical terms in the languages that they are fluent in. In addition, users can provide the back translation of the foreign terms to English. This web service will be interactive for both developers and users.
        </h4>
        <h3> Third Parties Technology.</h3>
        <h4> Moses-Translation Machine</h4>
	</div>
</div>
<div id="footer">
	<div class="container">
